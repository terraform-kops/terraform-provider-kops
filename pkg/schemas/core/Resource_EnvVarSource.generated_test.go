...
func TestExpandResourceEnvVarSource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := ExpandResourceEnvVarSource(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("ExpandResourceEnvVarSource() mismatch (-want +got):\n%s", diff)
			}
		})
	}
}

func TestFlattenResourceEnvVarSourceInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			FlattenResourceEnvVarSourceInto(tt.args.in, got)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("FlattenResourceEnvVarSource() mismatch (-want +got):\n%s", diff)
			}
		})
	}
}

func TestFlattenResourceEnvVarSource(t *testing.T) {
	_default := map[string]interface{}{
		"field_ref":          nil,
		"resource_field_ref": nil,
		"config_map_key_ref": nil,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := FlattenResourceEnvVarSource(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("FlattenResourceEnvVarSource() mismatch (-want +got):\n%s", diff)
			}
		})
