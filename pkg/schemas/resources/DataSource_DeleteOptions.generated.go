...
func DataSourceDeleteOptions() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			"interval": ComputedDuration(),
			"wait":     ComputedDuration(),
			"count":    ComputedInt(),
		},
	}
...
func ExpandDataSourceDeleteOptions(in map[string]interface{}) resources.DeleteOptions {
	if in == nil {
...
func FlattenDataSourceDeleteOptionsInto(in resources.DeleteOptions, out map[string]interface{}) {
...
func FlattenDataSourceDeleteOptions(in resources.DeleteOptions) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceDeleteOptionsInto(in, out)
	return out
}
