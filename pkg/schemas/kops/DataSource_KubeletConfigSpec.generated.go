...
func DataSourceKubeletConfigSpec() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"event_record_qps":            ComputedInt(),
			"node_lease_duration_seconds": ComputedInt(),
		},
	}
...
func ExpandDataSourceKubeletConfigSpec(in map[string]interface{}) kops.KubeletConfigSpec {
	...
	return kops.KubeletConfigSpec{
		...
		EventRecordQPS: func(in interface{}) *int32 {
			if in == nil {
				return nil
			}
			if reflect.DeepEqual(in, reflect.Zero(reflect.TypeOf(in)).Interface()) {
		...
		NodeLeaseDurationSeconds: func(in interface{}) *int32 {
			if in == nil {
				return nil
			}
			if reflect.DeepEqual(in, reflect.Zero(reflect.TypeOf(in)).Interface()) {
		...
		}(in["node_lease_duration_seconds"]),
	}
}
...
func FlattenDataSourceKubeletConfigSpecInto(in kops.KubeletConfigSpec, out map[string]interface{}) {
	...
	out["event_record_qps"] = func(in *int32) interface{} {
		return func(in *int32) interface{} {
			if in == nil {
				return nil
			}
	...
	out["node_lease_duration_seconds"] = func(in *int32) interface{} {
		return func(in *int32) interface{} {
			if in == nil {
				return nil
			}
