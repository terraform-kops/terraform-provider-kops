...
func DataSourceNetworkingSpec() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"gcp":                      ComputedStruct(DataSourceGCPNetworkingSpec()),
			"kindnet":                  ComputedStruct(DataSourceKindnetNetworkingSpec()),
		},
	}
		...
		GCP: func(in interface{}) *kops.GCPNetworkingSpec {
			return func(in interface{}) *kops.GCPNetworkingSpec {
				...
				return func(in kops.GCPNetworkingSpec) *kops.GCPNetworkingSpec {
					...
					if in, ok := in.([]interface{}); ok && len(in) == 1 && in[0] != nil {
						return ExpandDataSourceGCPNetworkingSpec(in[0].(map[string]interface{}))
					}
		...
		Kindnet: func(in interface{}) *kops.KindnetNetworkingSpec {
			return func(in interface{}) *kops.KindnetNetworkingSpec {
				...
				return func(in kops.KindnetNetworkingSpec) *kops.KindnetNetworkingSpec {
					...
					if in, ok := in.([]interface{}); ok && len(in) == 1 && in[0] != nil {
						return ExpandDataSourceKindnetNetworkingSpec(in[0].(map[string]interface{}))
					}
...
func FlattenDataSourceNetworkingSpecInto(in kops.NetworkingSpec, out map[string]interface{}) {
	...
	out["gcp"] = func(in *kops.GCPNetworkingSpec) interface{} {
		return func(in *kops.GCPNetworkingSpec) interface{} {
			...
			return func(in kops.GCPNetworkingSpec) interface{} {
				return func(in kops.GCPNetworkingSpec) []interface{} {
					return []interface{}{FlattenDataSourceGCPNetworkingSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.GCP)
	out["kindnet"] = func(in *kops.KindnetNetworkingSpec) interface{} {
		return func(in *kops.KindnetNetworkingSpec) interface{} {
			...
			return func(in kops.KindnetNetworkingSpec) interface{} {
				return func(in kops.KindnetNetworkingSpec) []interface{} {
					return []interface{}{FlattenDataSourceKindnetNetworkingSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Kindnet)
