...
func ResourceCiliumNetworkingSpec() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"enable_l7_proxy":                   Nullable(OptionalBool()),
			...
			"operator_pod_annotations":          OptionalMap(String()),
			...
			"ipam":                              OptionalString(),
			"install_iptables_rules":            Nullable(OptionalBool()),
			...
			"cni_exclusive":                     Nullable(OptionalBool()),
		...
		Ingress: func(in interface{}) *kops.CiliumIngressSpec {
			return func(in interface{}) *kops.CiliumIngressSpec {
				...
				return func(in kops.CiliumIngressSpec) *kops.CiliumIngressSpec {
					...
					if in, ok := in.([]interface{}); ok && len(in) == 1 && in[0] != nil {
						return ExpandResourceCiliumIngressSpec(in[0].(map[string]interface{}))
					}
		...
		GatewayAPI: func(in interface{}) *kops.CiliumGatewayAPISpec {
			return func(in interface{}) *kops.CiliumGatewayAPISpec {
				...
				return func(in kops.CiliumGatewayAPISpec) *kops.CiliumGatewayAPISpec {
					...
					if in, ok := in.([]interface{}); ok && len(in) == 1 && in[0] != nil {
						return ExpandResourceCiliumGatewayAPISpec(in[0].(map[string]interface{}))
					}
...
func FlattenResourceCiliumNetworkingSpecInto(in kops.CiliumNetworkingSpec, out map[string]interface{}) {
	...
	out["ingress"] = func(in *kops.CiliumIngressSpec) interface{} {
		return func(in *kops.CiliumIngressSpec) interface{} {
			...
			return func(in kops.CiliumIngressSpec) interface{} {
				return func(in kops.CiliumIngressSpec) []interface{} {
					return []interface{}{FlattenResourceCiliumIngressSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Ingress)
	out["gateway_api"] = func(in *kops.CiliumGatewayAPISpec) interface{} {
		return func(in *kops.CiliumGatewayAPISpec) interface{} {
			...
			return func(in kops.CiliumGatewayAPISpec) interface{} {
				return func(in kops.CiliumGatewayAPISpec) []interface{} {
					return []interface{}{FlattenResourceCiliumGatewayAPISpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.GatewayAPI)
