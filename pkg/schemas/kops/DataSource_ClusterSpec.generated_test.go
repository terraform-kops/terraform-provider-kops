...
func TestExpandDataSourceClusterSpec(t *testing.T) {
	...
	}{
		{
			...
			args: args{
				in: map[string]interface{}{
					...
					"config_store": func() []interface{} { return []interface{}{FlattenDataSourceConfigStoreSpec(kops.ConfigStoreSpec{})} }(),
					...
					"metrics_server":                    nil,
					"cert_manager":                      nil,
					"networking":                        func() []interface{} { return []interface{}{FlattenDataSourceNetworkingSpec(kops.NetworkingSpec{})} }(),
					"api":                               func() []interface{} { return []interface{}{FlattenDataSourceAPISpec(kops.APISpec{})} }(),
					"authentication":                    nil,
					"authorization":                     nil,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := ExpandDataSourceClusterSpec(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("ExpandDataSourceClusterSpec() mismatch (-want +got):\n%s", diff)
			}
		})
	}
}
...
func TestFlattenDataSourceClusterSpecInto(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			FlattenDataSourceClusterSpecInto(tt.args.in, got)
			if diff := cmp.Diff(tt.want, got); diff != "" {
...
func TestFlattenDataSourceClusterSpec(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := FlattenDataSourceClusterSpec(tt.args.in)
			if diff := cmp.Diff(tt.want, got); diff != "" {
				t.Errorf("FlattenDataSourceClusterSpec() mismatch (-want +got):\n%s", diff)
			}
		})
