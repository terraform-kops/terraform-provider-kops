...
func ResourceNRIConfig() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			"enabled":                     OptionalBool(),
			"plugin_registration_timeout": OptionalDuration(),
			"plugin_request_timeout":      OptionalDuration(),
		},
	}
...
func ExpandResourceNRIConfig(in map[string]interface{}) kops.NRIConfig {
	if in == nil {
...
func FlattenResourceNRIConfigInto(in kops.NRIConfig, out map[string]interface{}) {
...
func FlattenResourceNRIConfig(in kops.NRIConfig) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenResourceNRIConfigInto(in, out)
	return out
}
