...
func DataSourceKindnetNetworkingSpec() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			"version":                         ComputedString(),
			"network_policies":                ComputedBool(),
			"admin_network_policies":          ComputedBool(),
			"baseline_admin_network_policies": ComputedBool(),
			"dns_caching":                     ComputedBool(),
			"nat64":                           ComputedBool(),
			"fast_path_threshold":             ComputedInt(),
			"masquerade":                      ComputedStruct(DataSourceKindnetMasqueradeSpec()),
...
func ExpandDataSourceKindnetNetworkingSpec(in map[string]interface{}) kops.KindnetNetworkingSpec {
	if in == nil {
			...
			return func(in interface{}) *kops.KindnetMasqueradeSpec {
				...
				return func(in kops.KindnetMasqueradeSpec) *kops.KindnetMasqueradeSpec {
					...
					if in, ok := in.([]interface{}); ok && len(in) == 1 && in[0] != nil {
						return ExpandDataSourceKindnetMasqueradeSpec(in[0].(map[string]interface{}))
					}
...
func FlattenDataSourceKindnetNetworkingSpecInto(in kops.KindnetNetworkingSpec, out map[string]interface{}) {
	...
	out["masquerade"] = func(in *kops.KindnetMasqueradeSpec) interface{} {
		return func(in *kops.KindnetMasqueradeSpec) interface{} {
			...
			return func(in kops.KindnetMasqueradeSpec) interface{} {
				return func(in kops.KindnetMasqueradeSpec) []interface{} {
					return []interface{}{FlattenDataSourceKindnetMasqueradeSpec(in)}
				}(in)
			}(*in)
		}(in)
	}(in.Masquerade)
...
func FlattenDataSourceKindnetNetworkingSpec(in kops.KindnetNetworkingSpec) map[string]interface{} {
	out := map[string]interface{}{}
	FlattenDataSourceKindnetNetworkingSpecInto(in, out)
	return out
}
