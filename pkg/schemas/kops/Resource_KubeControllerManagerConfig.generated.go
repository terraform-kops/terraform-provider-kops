...
func ResourceKubeControllerManagerConfig() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"concurrent_horizontal_pod_austoscaler_syncs":         OptionalInt(),
			"concurrent_job_syncs":                                OptionalInt(),
			...
			"endpoint_updates_batch_period":                       OptionalDuration(),
			"endpoint_slice_updates_batch_period":                 OptionalDuration(),
